...
export const Header: React.FC<HeaderProps> = ({
  ...
  // 直读 store：路由/登录态/技能/需求/后端状态全部自取，App 层不再为 Header 逐项透传
  // （与 Footer 的 store 直读策略一致）。依赖 DAG：routerStore / authStore / skillsStore /
  // demandsStore 均无环，usePermissions 复用 App 侧同一份菜单权限推导，避免两处漂移。
  ...
  // 待审计数 = 待审技能 + 待审需求；个人中心徽标 = 我的收藏 + 我的投稿
